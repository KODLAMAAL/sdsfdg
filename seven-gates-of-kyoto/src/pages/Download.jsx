...
export default function DownloadPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-6">
      <div className="max-w-lg w-full bg-card border border-border rounded-2xl p-8 text-center space-y-6">
        ...
        {status === 'done' && (
          <p className="text-secondary text-sm font-body italic">
            "The code is yours, traveler. Use it wisely."
          </p>
        )}
      </div>
    </div>
